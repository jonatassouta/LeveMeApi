...
namespace LeveMv.Data.Context
{
    public class LeveMeContext : DbContext
    {
        ...
        public DbSet<Levemv> LeveMes { get; set; }
        public DbSet<ClienteLeveMv> ClientesLMEs { get; set; }

        protected void InitializeData(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Cliente>().HasData(
                new Cliente { ID = new Guid("6714d050-cbad-4951-b819-3641e4647f1c") , Nome = "Jonatas", CNPJ = 11122233345678, Telefone = "16999998888", Endereço = "Av. Teste", Bairro = "Vila Xavier", Cidade = "Araraquara", UF = "SP", DataCadastro = DateTime.Parse("16/05/2025"), Ativo = true });
            ...
            modelBuilder.Entity<ClienteLeveMv>().HasData(
                new ClienteLeveMv { ClienteId = new Guid("6714d050-cbad-4951-b819-3641e4647f1c"), LeveMvId = new Guid("fa974954-c32d-4e62-9154-c77d14445525")});
